    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-7">
                <div class="widget">
                    <div class="footer-text text-left">
                        ...
                        <p>Blog cá nhân - Nơi chia sẻ những câu chuyện và suy nghĩ của bạn.</p>
                        <div class="social">
            ...
            <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
                <div class="widget">
                    <h2 class="widget-title">Chuyên mục phổ biến</h2>
                    <div class="link-widget">
                        <ul>
                            <li><a href="#">Nấu ăn <span>(21)</span></a></li>
                            <li><a href="#">Thể Thao <span>(15)</span></a></li>
                            <li><a href="#">Du lịch <span>(31)</span></a></li>
                            <li><a href="#">Công nghệ <span>(22)</span></a></li>
                            <li><a href="#">Âm nhạc <span>(66)</span></a></li>
                        </ul>
                    </div><!-- end link-widget -->
                </div><!-- end widget -->
            </div><!-- end col -->
                ...
                <div class="widget">
                    ...
                    <div class="link-widget">
                        <ul>
                            ...
                            <li><a href="#">Giấy phép & Hỗ trợ</a></li>
                        </ul>
                    </div><!-- end link-widget -->
                </div><!-- end widget -->
            </div><!-- end col -->
